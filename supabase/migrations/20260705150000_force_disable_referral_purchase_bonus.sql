-- Force disable referral purchase bonuses for investments.
-- This migration overwrites any previous buy_investment/apply_referral_purchase_bonus
-- definitions to ensure the referral purchase flow no longer credits the referrer.
